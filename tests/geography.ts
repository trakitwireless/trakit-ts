...
describe("LatLng", () => {
	...
	it("toString", () => {
		var object1 = new LatLng(43.123456789, -79.123456789);
		expect(object1.toString()).toEqual("43.12345679,-79.12345679");
		expect(object1.toString(" ")).toEqual("43.12345679 -79.12345679");
	});
	it("toJSON", () => {
		var object1 = new LatLng(43.123456789, -79.123456789);
		expect(object1.toJSON()).toEqual({ lat: 43.12345679, lng: -79.12345679 });
	});
	it("equals", () => {
		var object1 = new LatLng(43.123456789, -79.123456789),
...
describe("LatLngBounds", () => {
	...
	it("equality", () => {
		...
		expect(object1.isEqual(object2)).toBe(true);
		expect(object1.isEqual(object3)).not.toBe(true);
		expect(object1).toEqual(object1.copy());
	});
	it("validity", () => {

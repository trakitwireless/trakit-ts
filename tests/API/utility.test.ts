...
import { CODIFY, HIGHLIGHT } from '../../src/API/Codifier';
import { FILESIZE_HELPER, NUMBER_GROUPS } from '../../src/API/Files';
import { CAPITALIZE, DATE, DOUGLASPEUCKER, ID, IS_AN, IS_NOTHING, PLURALIZE, ROUND_TO, SINGULARIZE } from '../../src/API/Functions';
import { PATH_ORTHOGONAL } from '../../src/API/Geometry/Functions';
import { Point } from '../../src/API/Geometry/Point';
import { GUID } from '../../src/API/Guid';
import { TIMEZONE_FIND, } from '../../src/API/Timezones';
